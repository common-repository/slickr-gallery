<?php
/* this file is just a copy of the standard wordpress inline-uploading.php, since there are no action hooks to modify this file's behavior */
...
/* Slickr: */
case 'photos':
    include(dirname(__FILE__).'/inline-photos.php');
break;
...
<?php } ?>
<li<?php echo $slickr_current_tab; ?>><a href="<?php echo basename(__FILE__); ?>?action=photos&amp;post=<?php echo $post; ?>">Photos</a></li>
<li> </li>
<?php if ( $action == 'view' || $action == 'photos') { ?>
<?php if ( false !== $back ) : ?>
<li class="spacer"><a href="<?php echo basename(__FILE__); ?>?action=<?php echo $action; ?>&amp;post=<?php echo $post; ?>&amp;all=<?php echo $all; ?>&amp;start=0<?php echo $extraVars?>" title="<?php _e('First'); ?>">|&laquo;</a></li>
<li><a href="<?php echo basename(__FILE__); ?>?action=<?php echo $action; ?>&amp;post=<?php echo $post; ?>&amp;all=<?php echo $all; ?>&amp;start=<?php echo $back; ?><?php echo $extraVars?>">&laquo; <?php _e('Back'); ?></a></li>
<?php else : ?>
<li class="inactive spacer">|&laquo;</li>
<li class="inactive">&laquo; <?php _e('Back'); ?></li>
<?php endif; ?>
<?php if ( false !== $next ) : ?>
<li><a href="<?php echo basename(__FILE__); ?>?action=<?php echo $action; ?>&amp;post=<?php echo $post; ?>&amp;all=<?php echo $all; ?>&amp;start=<?php echo $next; ?><?php echo $extraVars?>"><?php _e('Next'); ?> &raquo;</a></li>
<li><a href="<?php echo basename(__FILE__); ?>?action=<?php echo $action; ?>&amp;post=<?php echo $post; ?>&amp;all=<?php echo $all; ?>&amp;last=true<?php echo $extraVars?>" title="<?php _e('Last'); ?>">&raquo;|</a></li>
<?php else : ?>
...
<?php the_attachment_links($attachment); ?>
    ...
    <?php elseif ( $action == 'photos' ) : ?>
    <?php include(dirname(__FILE__).'/inline-photos.html');?>
<?php endif; ?>
</body>
</html>
